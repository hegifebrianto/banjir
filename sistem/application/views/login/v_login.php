    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="../../index2.html"><b>DSS SYSTEM</b>URBAN FLOOD</a>
            </div><!-- /.login-logo -->
            <div class="login-box-body">
                ...
                <form action="<?php echo site_url('login/login/validate_credentials'); ?>" method="post">
                    ...
                    <div class="row">
                        <div class="col-xs-8">
                            <div class="checkbox icheck">
                                <label>
                                    <input type="checkbox" class="flat"> Remember Me
                                </label>
                            </div>
                        </div><!-- /.col -->
                        <div class="col-xs-4">
