...
<html>
  ...
  <body class="skin-blue">
    ...
    <!-- jQuery 2.1.3 -->
    <script src="<?php echo base_url('assets/AdminLTE-2.0.5/plugins/jQuery/jQuery-2.1.3.min.js') ?>" type="text/javascript"></script>
    <!-- Bootstrap 3.3.2 JS -->
    ...
    <!-- FastClick -->
    <script src="<?php echo base_url('assets/AdminLTE-2.0.5/plugins/fastclick/fastclick.min.js') ?>" type="text/javascript"></script>
    <!-- AdminLTE App -->
