...
class perhitungan extends CI_Controller {
	...
	public function hitung_bobot()
    {
			...
			$data_hitung['cr'] = $datahitung['ci'] /0.90;
			...
			//natural breaks 
			//----------------------------------------------------
			array_multisort($tempku1, SORT_ASC, $tempku1);
			$breaks = $this->jenks_model->getBreaks( $tempku1, 3 );

			$cls = 1;
			$from = $tempku1[ 0 ];
			$prices = array_unique( $tempku1 );
			sort( $prices );
			...
			//----------------------------------------------------
			$batasawal  = array_values($btsawal);
			$batasakhir = array_values($btsakhir);
			$this->data['batasawal']=$batasawal;
			$this->data['batasakhir'] = $batasakhir;
			$nama_batas[0] ='Rendah';
			$nama_batas[1] ='Sedang';
			$nama_batas[2] ='Tinggi';
			$this->data['nama_batas'] = $nama_batas;
			//----------------------------------------------------		
